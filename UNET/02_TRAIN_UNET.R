                       ...
                       trainDir1="C:\\YandexDisk\\CURRENT WORK\\CELL SEGMENTATION 20241007\\DATA TRAIN\\TRAIN"
                      # weight1=Weight
...
########
if ( exists("unet1")==F){source("C:\\YandexDisk\\CURRENT WORK\\CELL SEGMENTATION 20241007\\CODE\\CELL-SEGMENTATION\\UNET\\UnetVGG16Create.r")}
...
img2arr <- function(image, 
                    target_width = 384,
                    target_height = 384) {
   result <- t(as.numeric(image[[1]])[, , 1]) # transpose
