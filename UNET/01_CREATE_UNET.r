...
unet1 <- function(shape, nlevels = 4, nfilters = 16, dropouts = c(0.3, 0.3, 0.3, 0.3, 0.3)){
...
#########################################################
unet1 <<- unet1(shape = c(384, 384, 1), nlevels = 4, nfilters = 8, dropouts = c(0.3, 0.3, 0.3, 0.3,0.3))
